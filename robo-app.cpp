...
// // Right Motor
// const int rightMotorPin1 = 22; // IO22//in3
...
// value="200"
// />
// <span class="speed-label" id="speedValue">200</span>
// </div>
// </div>
...
//   digitalWrite(rightMotorPin1, HIGH);
//   digitalWrite(rightMotorPin2, LOW);
//   ledcWrite(0, currentSpeed*0.6);
//   ledcWrite(1, currentSpeed*0.6);
// }
...
//   digitalWrite(rightMotorPin1, HIGH);
//   digitalWrite(rightMotorPin2, LOW);
//   ledcWrite(0, currentSpeed /2);  // Reduce left motor speed
//   ledcWrite(1, currentSpeed);
// }
...
//   digitalWrite(rightMotorPin2, LOW);
//   ledcWrite(0, currentSpeed);
//   ledcWrite(1, currentSpeed/2);  // Reduce right motor speed
// }
